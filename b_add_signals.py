...
class Window(QtWidgets.QWidget):
    ...
    def initSignals(self) -> None:
        ...
        self.comboBox.currentIndexChanged.connect(self.onComboBoxChanged)  # TODO подключить слот для вывода текста в plainTextEditLog при изменении выбранного элемента в comboBox
        self.spinBox.valueChanged.connect(self.onSpinBoxValueChanged)  # TODO подключить слот для вывода значения в plainTextEditLog при изменении значения в spinBox
    ...
    def onComboBoxChanged(self, index):
        """
        Обработка сигнала currentIndexChanged для comboBox
    ...
    def onSpinBoxValueChanged(self, value):
        ...
        :param value: новое значение spinBox
        :return: None
        """
        self.plainTextEditLog.setPlainText(str(value))

    def onDateTimeEditChanged(self, dateTime):
        """
        Обработка сигнала dateTimeChanged для dateTimeEdit

        :param dateTime: новая дата и время
        :return: None
        """
